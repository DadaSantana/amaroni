...
export const getAll = async () => {
    ...
    const q = query(newsRef, orderBy('order','desc'));
...
export const setNews = async (id: string, imageUrl: string, name: string, description: string, address: string, telephone: string, email: string, links: any[], create: string) => {
    const count =  await getAllLenght();
