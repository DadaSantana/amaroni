...
import two from '../assets/images/storia_two.jpeg';
import three from '../assets/images/storia_three.jpeg';
    ...
    return(
        <div id="app">
            ...
            <Container>
                ...
                >
                    <div className="texts">
                        <p style={{textAlign: 'justify'}}>Amaroni è un piccolo centro della provincia di Catanzaro, adagiato su una collina, alle falde del monte Carbonara, da cui è possibile ammirare lo splendido panorama del Golfo di Squillace. Ha origini antichissime, che risalgono alla preistoria, come dimostrano molti reperti.</p>
                        <p style={{textAlign: 'justify'}}>I primi abitanti s’insediarono lungo le rive del fiume Alessi, l’antico KARKINOS, dal nome della città greca che, secondo alcuni storici e archeologi, tra cui il Lenormant, qui sorgeva ed era identificato con la località “Majurizzoni”.</p>
                        <p style={{textAlign: 'justify'}}>Scrive il Lenormant che Amaroni, rectius tutta la Serralta di San Vito, rappresenta la parte più stretta dell’istmo che è la porta dell’ultimo tratto del prolungamento della penisola italiana verso mezzogiorno, in quel tratto che esso da solo portava il nome d’Italia, e in cui finiva l’Enotria.
                ...
                <motion.div 
                    ...
                    transition={{ ease: 'easeIn', duration: 0.5 }}
                >
                    <img src={two} alt="" className='img-left' />
                    <div className="texts">
                        <p style={{textAlign: 'justify'}}>Si narra che i primi insediamenti nacquero per effetto della fuga delle comunità da alcune zone costiere, sotto assedio dei Saraceni e di predoni, o di monaci basiliani, costretti a fuggire a causa dell’iconoclastia dalla Siria, dalla Palestina e dall’Egitto verso luoghi più sicuri.</p>
                    </div>
                </motion.div>
                <motion.div 
                    className="flex-content"
                ...
                >
                    <div className="texts">
                        <p style={{textAlign: 'justify'}}>Le origini Magno Greche di Amaroni sono confermate dalla forte presenza di vocaboli dialettali, tra cui: “grupu” (buco), “fanò” (abbaino), “catarrattu” (apertura del pavimento verso il basso), “holea” (nido di uccelli), “scifu” (recipiente in cui si versa il cibo per i maiali), “ciaramidu”, (tegola).
                    ...
                    <img src={three} alt="" className='img-right' />
                </motion.div>
                <motion.div 
                    className="flex-content"
                    initial={{ opacity: 0, translateY: '50px' }}
                ...
                >
                    ...
                    Nel Settecento Amaroni visse un secolo di avvenimenti importanti e dal 1799, per poco, fece parte della Repubblica Partenopea; il movimento repubblicano fu più attivo nei paesi della Calabria Citeriore, meno in Calabria Ultra, cui apparteneva Amaroni.
                </motion.p>
            </Container>
